...
public partial class BarCodeGenerator : IAsyncDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        try
        {
            ...
            module = await JS.InvokeAsync<IJSObjectReference>("import", "./_content/ZXingBlazor/BarCodeGenerator.razor.js" + "?v=" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version);
            await module!.InvokeVoidAsync("Gen", objRef, Element , "123456");
        }
        catch (Exception e)
        {
    ...
    /// <returns></returns>
    public async Task CodeGen(string input)
    {
        await module!.InvokeVoidAsync("Gen", objRef, Element, input);
    }
